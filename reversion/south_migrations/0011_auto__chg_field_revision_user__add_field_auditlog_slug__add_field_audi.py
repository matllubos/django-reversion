...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuditLog.slug'
        db.add_column(u'reversion_auditlog', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AuditLog.fingerprint'
        db.add_column(u'reversion_auditlog', 'fingerprint',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):

        # Deleting field 'AuditLog.slug'
        db.delete_column(u'reversion_auditlog', 'slug')

        # Deleting field 'AuditLog.fingerprint'
        db.delete_column(u'reversion_auditlog', 'fingerprint')
    ...
    models = {
        ...
        u'reversion.auditlog': {
            'Meta': {'ordering': "(u'-created_at',)", 'object_name': 'AuditLog'},
            'comment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'fingerprint': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
